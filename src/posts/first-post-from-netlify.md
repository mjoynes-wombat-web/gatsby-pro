...
image: /assets/cracky-crab.jpg
---
WOOOOOOO!

![Cracky Crab](/assets/cracky-crab.jpg)
...
![Before Selector Pairing](./article-resources/imgs/pre-selector-pairing.jpg title)

> Before Selector Pairing

![After Selector Pairing](./article-resources/imgs/post-selector-pairing.jpg title)
...
![Before Moving Dynamic Styling to Inline](./article-resources/imgs/pre-dynamic-to-inline-style.jpg title)

> Before Moving Dynamic Styling to Inline

![After Moving Dynamic Styling to Inline](./article-resources/imgs/post-dynamic-to-inline-style.jpg title)
...
![Frame Rate Drop when Crab is Clicked](./article-resources/imgs/click-frame-rate-drop.jpg title)
